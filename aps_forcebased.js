(function () {
    ...
    class NetworkGraphForceBasedAps extends HTMLElement {
        constructor() {
            super();
        ...
        _submit(e) {
            e.preventDefault();
            let properties = {};
            for (let name of NetworkGraphForceBasedAps.observedAttributes) {
    ...
    customElements.define("com-fd-djaja-sap-sac-networkgraphforcebased-aps", NetworkGraphForceBasedAps);
})();
