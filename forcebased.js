                ...
                return Controller.extend("myView.Template", {
                    ...
                    onInit: function () {
                        ...
                        if (that._firstConnection === 0) {
                            ...
                            $.ajax({
                                url: 'http://127.0.0.1:9000/hierarchy', //R Plumber REST API URL
                                type: 'GET',
                                async: true,
                                timeout: 0,
